			...
			<article class="weather-locations">
				<section class="select-location">
					...
					<form class="new-location" method="get">
						<input name="" value="" class="zip" type="text" placeholder="First Name">
						<input name="" value="" class="zip" type="email" placeholder="Email">
						<input name="" value="" class="zip" type="password" placeholder="Password">
